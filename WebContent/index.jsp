...
<html lang="en">
    ...
    <body>
      ...
      <!-- Navbar start here -->
      <nav class="navbar">
        <form action="./jsp/product.jsp" method="get" id="search-form" class="nav-item">
        ...
        <div id="nav-menu">
          ...
          <% 
			...
			if(name == null) {
          		out.println("<a href='./jsp/formPage.jsp'><i class='bi bi-person-fill nav-item'>Signin</i></a>");
			}
			else {
				out.println("<a href='./jsp/carts.jsp'><i class='bi bi-cart nav-item'>Cart</i></a>");
				out.println("<a href='./jsp/logout.jsp'><i class='bi bi-power nav-item'>logout</i></a>");
			}
		  %>
        </div>
      </nav>
      ...
      <footer id="about">
      	<div class="left">
	      	<h1>Know More...</h1>
	      	<br/>
			<a href="./jsp/terms.jsp"><i class="bi bi-box-arrow-up-right"></i> terms &amp; condition</a><br/>
			<a href="./jsp/privacy.jsp"><i class="bi bi-card-text"></i> privacy policy</a><br/>
			<a href="./jsp/help.jsp"><i class="bi bi-info-circle"></i> help</a><br/>
		</div>
		<div class="right">
